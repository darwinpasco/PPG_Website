...
| `logos/Park-Secure-Management-Corporation-logo.png` | PNG, 1600 x 1423, 126.9 KB, landscape, transparent | Park Secure company mark | Selected for Home and company pages | `src/assets/brand/park-secure-logo.png` | Only supplied Park Secure variant and clearly associated with the company. Used with the same logo-well dimensions as Pro-P. Confirm final publication and usage guidance. |
| `logos/Professional-Parking-Management-Corporation-logo.png` | PNG, 1600 x 796, 52.8 KB, landscape, transparent | Pro-P company mark | Selected for Home and company pages | `src/assets/brand/pro-p-logo.png` | Only supplied Pro-P variant and clearly associated with the company. Used with the same logo-well dimensions as Park Secure. Confirm final publication and usage guidance. |
